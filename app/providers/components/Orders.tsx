  ...
  return (
      <div className="max-w-[1254px] lg:mx-auto mx-5 lg:my-[100px] my-[50px]">
          <div className="flex md:flex-row flex-col justify-between md:mb-[60px] phone:mb-10 mb-[30px]">
              ...
              <div className="md:w-[49%] w-[100%]">
                  <p className="text-darkText font-normal text-lg leading-7">
                      ...
                      equipment a seamless and hassle-free experience. Here is a
                      step-by-step breakdown of how our service works.
                  </p>
              </div>
          </div>
          ...
          <div className="flex phone:flex-row flex-col justify-center items-center gap-5 lg:mt-[60px] mt-10">
              <Button className="text-sm tracking-extra-tight leading-[21px] phone:w-[auto] w-full font-semibold text-white py-[14px] px-6 bg-darkText rounded-[100px]">
              ...
              <Button className="text-sm tracking-extra-tight leading-[21px] phone:w-[auto] w-full font-semibold text-white py-[14px] px-6 lg:bg-darkText bg-darkGold rounded-[100px]">
